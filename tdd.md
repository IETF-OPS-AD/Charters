...
There is no uniform format of a TDD session, but TDD is primarily designed to share information rather than solve problems. A TDD session can combine both tutorial presentation and demos. 
